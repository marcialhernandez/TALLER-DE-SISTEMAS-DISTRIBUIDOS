...
class hiloChat extends Thread {
    ...
    Scanner entradaChat;
    volatile MessengerInterface sesionCliente;
    ...
    MessengerInterface getMessengerActual() {
        return this.sesionCliente;
    }
...
public class Cliente {
    ...
    public static void comprueba(int[][] matrizz, int cantidadJugadores,PaginaPrincipal ventanaPrincipal, InterfazTableroServer tablero) throws RemoteException {

        if (cantidadJugadores == 2) {
            if (ventanaPrincipal.numeroJugador == 1) {
                if (matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+5] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][5] = 8;
                    tablero.setPosicion8(0, 5);
                    
                }else if(matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+5] == 0){
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+5]=8;
                    tablero.setPosicion8(ventanaPrincipal.posicionFila, ventanaPrincipal.posicionColumna+5);
                }else{
                    System.out.println("GANASTE");
                   
                }
                tablero.setTablero2(matrizz);
            }
            if (ventanaPrincipal.numeroJugador == 2) {
                if (matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna-5] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][0] = 8;
                    tablero.setPosicion8(0,0);
        ...
        if (cantidadJugadores == 4) {
            if (ventanaPrincipal.numeroJugador == 1) {
                if (matrizz[ventanaPrincipal.posicionFila+5][ventanaPrincipal.posicionColumna] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[5][0] = 8;
                    tablero.setPosicion8(5, 0);
                    
                }else if(matrizz[ventanaPrincipal.posicionFila+5][ventanaPrincipal.posicionColumna] == 0){
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[ventanaPrincipal.posicionFila+5][ventanaPrincipal.posicionColumna]=8;
                    tablero.setPosicion8(ventanaPrincipal.posicionFila+5, ventanaPrincipal.posicionColumna);
                }else{
                    System.out.println("GANASTE");
                   
                }
                tablero.setTablero4(matrizz);
            }
            if (ventanaPrincipal.numeroJugador == 2) {
                if (matrizz[ventanaPrincipal.posicionFila-5][ventanaPrincipal.posicionColumna+5] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][5] = 8;
                    tablero.setPosicion8(0,5);
                    
                }else if(matrizz[ventanaPrincipal.posicionFila-5][ventanaPrincipal.posicionColumna+5] == 0){
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[ventanaPrincipal.posicionFila-5][ventanaPrincipal.posicionColumna+5]=8;
                    tablero.setPosicion8(ventanaPrincipal.posicionFila-5, ventanaPrincipal.posicionColumna+5);
                }else{
                    System.out.println("GANASTE");
            ...
            if (ventanaPrincipal.numeroJugador == 3) {
                if (matrizz[ventanaPrincipal.posicionFila+5][ventanaPrincipal.posicionColumna] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[5][5] = 8;
                    tablero.setPosicion8(5, 5);
            ...
            if (ventanaPrincipal.numeroJugador == 4) {
                if (matrizz[ventanaPrincipal.posicionFila-5][ventanaPrincipal.posicionColumna-5] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][0] = 8;
                    tablero.setPosicion8(0,0);
        ...
        if (cantidadJugadores == 5) {
 if (ventanaPrincipal.numeroJugador == 1) {
                if (matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+2] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][2] = 8;
                    tablero.setPosicion8(0, 2);
                    
                }else if(matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+2] == 0){
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+2]=8;
                    tablero.setPosicion8(ventanaPrincipal.posicionFila, ventanaPrincipal.posicionColumna+2);
                }else{
                    System.out.println("GANASTE");
                   
                }
                tablero.setTablero5(matrizz);
            }
            if (ventanaPrincipal.numeroJugador == 2) {
                if (matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna+2] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
            ...
            if (ventanaPrincipal.numeroJugador == 5) {
                if (matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna-8] == 1) {
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[0][0] = 8;
                    tablero.setPosicion8(0,0);
                    
                }else if(matrizz[ventanaPrincipal.posicionFila-5][ventanaPrincipal.posicionColumna-8] == 0){
                    matrizz[tablero.getPosicion8X()][tablero.getPosicion8Y()] = 0;
                    matrizz[ventanaPrincipal.posicionFila][ventanaPrincipal.posicionColumna-8]=8;
                    tablero.setPosicion8(ventanaPrincipal.posicionFila, ventanaPrincipal.posicionColumna-8);
                }else{
                    System.out.println("GANASTE");
            ...
            if (conexion.iniciarRegistro(IPServer, Puerto, nombreReferenciaRemota) && conexion.iniciarRegistroChat(IPServer, Puerto, nombreReferenciaRemotaChat) && conexion.iniciarRegistroTablero(IPServer, Puerto, nombreReferenciaRemotaTablero)) {
                ...
                while (opcion != 5) {
                    ...
                    if (opcion == 1) {
                        ...
                        //System.out.println(chatActual.getMessengerActual().getTurnoCliente());
                        //sacaMatriz(int[][] matrizz, int jugador, int cantidadJugadores, int ratonx, int ratony, int salidax, int saliday)
                        int matrizMostrar[][] = objetoRemotoTablero.getTablero(conexion.getServidorChat());
                        ...
                        //*********************************************************************
                        //*********** IMPORTANTE ASIGNAR (posicionFila y posicionColumna)
                        //*********************************************************************
                        VentanaPrincipal.posicionFila = objetoRemotoTablero.getPosicion8X();
                        VentanaPrincipal.posicionColumna = objetoRemotoTablero.getPosicion8Y();
                        VentanaPrincipal.numeroJugador = chatActual.getMessengerActual().getTurnoCliente();
                        ...
                        //comprueba(int[][] matrizz, int cantidadJugadores, int salidax, int saliday, PaginaPrincipal ventanaPrincipal, InterfazTableroServer tablero) throws RemoteException {
                        //*****************************************************************
                        //METODO QUE ACTUALIZA LOS DATOS DEL SERVIDOR
                        //*****************************************************************
                        
                        comprueba(matrizMostrar, cantidadUsuariosON, VentanaPrincipal, objetoRemotoTablero);
                        ...
                        //*********************************************************
                        //*********** NO SE COMO HACERLO (tablero10 no funciona)
                        //*********************************************************
                        while(!NO SEA TU TURNO){
                         // esperar tu turno
                        ...
                        while (banderaChat == true) {
                            ...
                            if (!VentanaPrincipal.limitador) {

                            }

                        }
                        //VentanaPrincipal.posicionFila;
                    } else if (opcion == 4) {
