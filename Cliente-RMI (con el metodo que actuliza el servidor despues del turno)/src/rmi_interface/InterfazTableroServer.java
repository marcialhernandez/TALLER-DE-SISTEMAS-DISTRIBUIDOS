...
public interface InterfazTableroServer extends Remote {
    ...
    //public int[][] getTablero(int cantidadJugadore) throws RemoteException;
    //public void setTablero(int cantidadJugadore, int[][] tableroRecivido) throws RemoteException;
